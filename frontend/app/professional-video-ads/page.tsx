    ...
    <main>
      <section className="section">
        ...
        <p className="section-intro">
          Mode B bridges raw UGC trust and polished narrative structure. Use extend-chain when you
          want one seamless emotional arc, or cut-chain when scene contrast drives the story.
        </p>
      </section>
